                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="text-center">
                                                            <img src="dist/img/me2.jpg" class="img-fluid" alt="Profile Image">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <ul class="list-group list-group-flush">
                                                            <li class="list-group-item"><strong>Nama :</strong> Luluk Dwi Kuncoro</li>
                                                            <li class="list-group-item"><strong>NIM :</strong> 0110223203</li>
